...
openssl s_client -showcerts -connect "master.apis.dev.openstreetmap.org:443" -servername master.apis.dev.openstreetmap.org </dev/null | sed -ne '/-BEGIN CERTIFICATE-/,/-END CERTIFICATE-/p' > osm_dev.pem
keytool -delete -alias master.apis.dev.openstreetmap.org -keystore osmcacerts_dev -storepass openstreetmap
keytool -importcert -noprompt -trustcacerts -alias master.apis.dev.openstreetmap.org -file osm_dev.pem -keystore osmcacerts_dev -storepass openstreetmap
